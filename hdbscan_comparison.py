...
if dataset in ['standart','moons','gaussian-sparse'] and N == 5000:
    exit()
...
def instatiate_dataset(N,D,name):
    ...
    if name == 'standart': 
        ...
        df = pd.read_csv('datasets/archive/Frogs_MFCCs.csv').iloc[:,1:-4]
...
class ClusteringHDBSCAN:
    ...
    def cluster(self,data):
        ...
        print(self.clusterer.algorithm)
...
def main(args):
    ...
    file_name = 'artificial_hdbscan_experiments.csv'
